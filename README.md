...
- **Bug report**: Cấu trúc chuẩn title / steps / expected / actual / severity / priority
- **Công cụ**: Hướng dẫn Postman, SQL verify DB, đọc log
- **Mô phỏng**: Scenario thực tế để luyện tập
...
| Bug report | Mẫu bug report chuẩn |
| Công cụ | Postman, SQL, log |
| Mô phỏng | Scenario luyện tập |
